...
const allCriteria: Criterion[] = [
  ...
  { id: 'critere-1-4', text: 'CA/COPIL d\'au moins 6 membres divers (entreprises, éducation, territoire), signataires de la charte éthique.', category: 'Structure et statut juridique' },
  { id: 'critere-1-5', text: 'Réunions CA/COPIL ≥ 3 fois/an avec comptes-rendus.', category: 'Structure et statut juridique' },
  { id: 'critere-1-6', text: 'CA/COPIL garant du label et du suivi des actions correctives post-audit.', category: 'Structure et statut juridique' },
