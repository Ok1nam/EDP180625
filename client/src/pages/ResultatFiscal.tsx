...
import { Download, FileText, TrendingUp, Briefcase } from "lucide-react";
  ...
  return (
    <section id="resultat-fiscal" className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="flex items-center gap-2 mb-6 text-3xl font-bold text-gray-800">
        ...
        Trame de calcul du résultat fiscal de votre client
      </h1>

      <p className="mb-8 text-lg text-gray-700 leading-relaxed">
        En tant qu'expert-comptable, la détermination du résultat fiscal d'une école de production est une étape fondamentale. Elle exige une méthodologie rigoureuse pour concilier le résultat comptable et le résultat imposable. Cette trame est un outil essentiel pour vous, elle vous aide à identifier et appliquer les retraitements extra-comptables spécifiques à ces établissements, garantissant ainsi une déclaration fiscale précise et conforme pour l'école que vous accompagnez.
      </p>
      ...
      <Card className="mb-8 shadow-md">
        ...
        <CardContent className="text-gray-700 space-y-4">
          ...
          <p>
            Notre fichier Excel vous guide pas à pas dans l'application de ces ajustements, vous permettant ainsi d'obtenir un résultat fiscal fiable et conforme pour votre client.
          </p>
        </CardContent>
      </Card>
        ...
        <CardContent className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div className="text-base text-gray-800 flex-1">
            ...
            <p className="text-sm text-gray-600">
              <span className="font-bold">Note importante :</span> ce fichier est <span className="font-bold">lié</span> à plusieurs de nos outils. Il est essentiel de le remplir avec les données spécifiques de l'école de production de votre client avant d'utiliser les calculateurs.
            </p>
          </div>
          <a
            href={excelFilePath}
      ...
      <Card className="shadow-md">
        ...
        <CardContent className="text-gray-700 space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li><span className="font-bold">point de départ :</span> basez-vous toujours sur le bilan et le compte de résultat comptable finalisé de l'établissement.</li>
            <li><span className="font-bold">identification des retraitements :</span> identifiez méticuleusement toutes les charges et produits pouvant faire l'objet de retraitements fiscaux, spécifiques aux organismes sans but lucratif ou aux écoles de production.</li>
            <li><span className="font-bold">veille fiscale :</span> restez informé des évolutions de la législation fiscale en vigueur.</li>
            <li><span className="font-bold">validation :</span> pour les situations complexes, n'hésitez pas à solliciter l'avis d'un spécialiste en droit fiscal.</li>
          </ul>
          <p>
