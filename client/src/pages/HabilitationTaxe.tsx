...
export default function CriteresLabel({ navigate }: CriteresLabelProps) {
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">Habilitation taxe d'apprentissage</h1>
      <p className="text-gray-700 leading-relaxed">
        Habilitation taxe d'apprentissage : cette page est en cours de développement
      </p>
