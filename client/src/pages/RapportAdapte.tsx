...
import { Download, FileText, Share2, Award, PiggyBank, Users, Lightbulb } from "lucide-react";
      ...
      <Card className="mb-6 shadow-md">
        ...
        <CardContent className="p-6 text-gray-700 space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><span className="font-bold">Rassurer les financeurs</span> en présentant une gestion saine et l'atteinte des objectifs grâce aux suivis financiers et de subventions.</li>
            ...
            <li><span className="font-bold">Faciliter les renouvellements</span> en créant un historique prouvant l'efficacité de ses actions.</li>
            <li><span className="font-bold">Valoriser son équipe</span> en mettant en avant le travail et l'engagement de tous les acteurs.</li>
          </ul>
        </CardContent>
      </Card>
