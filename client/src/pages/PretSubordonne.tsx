...
import { Handshake, PiggyBank, FileText, Download } from "lucide-react"; // Icônes pertinentes
...
export default function PretSubordonne({ navigate }: PretSubordonneProps) {
  return (
    <section id="pret-subordonne" className="max-w-4xl mx-auto px-4 py-8">
      ...
      {/* Section Télécharger le Modèle de Contrat de Prêt Subordonné */}
      <Card className="mb-6 shadow-md">
        <CardHeader className="bg-gray-50 border-b">
          <CardTitle className="text-xl font-bold text-gray-700 flex items-center gap-2">
            <Download className="w-5 h-5 text-blue-600" />
            Télécharger le Modèle de Contrat de Prêt Subordonné
          </CardTitle>
        </CardHeader>
