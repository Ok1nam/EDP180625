...
const Card = ({ children, onClick }) => (
  <div
    className="bg-white rounded-xl shadow-lg border border-gray-200 cursor-pointer transition-transform duration-200 hover:scale-105 h-full flex flex-col"
    onClick={onClick}
  >
    {children}
  </div>
...
const CardContent = ({ children }) => <div className="p-6 flex-grow">{children}</div>;

// Données des outils avec la fusion effectuée
const outils = [
